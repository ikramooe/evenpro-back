	...
	var U = {
		...
		se = {
			...
			getPathValues: function (e) {
				var t = l(),
					a = (e ? new URL(https://devsnews.com/template/growbiz/growbiz/e/) : t.location).pathname
						.slice(1)
						.split("https://www.devsnews.com/")
						.filter(function (e) {
							return "" !== e;
						}),
					i = a.length;
			...
			setHistory: function (e, t) {
				...
				if (a.history.initialized && a.params.history.enabled) {
					var s;
					s = a.params.url ? new URL(https://devsnews.com/template/growbiz/growbiz/a.params.url/) : i.location;
					var r = a.slides.eq(t),
